...
io_combined = open(name = 'combined.dat', mode = 'w+')
io_response = open(name = 'response.dat', mode = 'w+')
io_request = open(name = 'request.dat', mode = 'w+')
io_container = open(name = 'container.dat', mode = 'w+')
